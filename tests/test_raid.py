...
class TestCheckRaidPool:
    ...
    Consistency Policy : resync
        ...
        expected = (
            ' {"raid": {"Consistency Policy": "resync", "Working Devices": "1", "Raid'
            ' Devices": "2", "Raid Level": "raid1", "Creation Time": "Wed May 26'
            ' 14:31:03 2021", "Used Dev Size": "62914432 (60.00 GiB 64.42 GB)", "UUID":'
            ' "d42790a9:d65c0409:102ec755:53215d89", "Array Size": "62914432 (60.00 GiB'
            ' 64.42 GB)", "Failed Devices": "0", "State": "clean, degraded", "Version":'
            ' "1.0", "Events": "1076", "Persistence": "Superblock is persistent",'
            ' "Spare Devices": "0", "Name": "localhost:127", "Active Devices": "1",'
            ' "Total Devices": "1", "Update Time": "Wed Jul 21 11:18:58 2021"},'
            ' "volumes": [["2", "8", "0", "0", "active sync", "/dev/sda"], ["-", "0",'
            ' "0", "1", "removed"]]}'
        )
