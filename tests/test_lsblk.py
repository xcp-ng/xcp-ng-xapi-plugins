...
NAME="sda6" KNAME="sda6" PKNAME="sda" SIZE="1073741824" TYPE="part" RO="0" MOUNTPOINT="[SWAP]"'''
        ...
        expected = (
            ' {"blockdevices": [{"kname": "sdb", "name": "sdb", "pkname": "",'
            ' "mountpoint": "", "ro": "0", "type": "disk", "size": "64424509440"},'
            ' {"kname": "sda", "name": "sda", "pkname": "", "mountpoint": "", "ro":'
            ' "0", "type": "disk", "children": [{"kname": "sda4", "name": "sda4",'
            ' "pkname": "sda", "mountpoint": "", "ro": "0", "type": "part", "size":'
            ' "536870912"}, {"kname": "sda2", "name": "sda2", "pkname": "sda",'
            ' "mountpoint": "", "ro": "0", "type": "part", "size": "19327352832"},'
            ' {"kname": "sda5", "name": "sda5", "pkname": "sda", "mountpoint":'
            ' "/var/log", "ro": "0", "type": "part", "size": "4294967296"}, {"kname":'
            ' "sda3", "name": "sda3", "pkname": "sda", "mountpoint": "", "ro": "0",'
            ' "type": "part", "children": [{"kname": "dm-0", "name":'
            ' "XSLocalEXT--1fad55d2--4f07--8145--c78a--297b173e06b0-1fad55d2--4f07--8145--c78a--297b173e06b0",'
            ' "pkname": "sda3", "mountpoint":'
            ' "/run/sr-mount/1fad55d2-4f07-8145-c78a-297b173e06b0", "ro": "0", "type":'
            ' "lvm", "size": "19847446528"}], "size": "19863158272"}, {"kname": "sda1",'
            ' "name": "sda1", "pkname": "sda", "mountpoint": "/", "ro": "0", "type":'
            ' "part", "size": "19327352832"}, {"kname": "sda6", "name": "sda6",'
            ' "pkname": "sda", "mountpoint": "[SWAP]", "ro": "0", "type": "part",'
            ' "size": "1073741824"}], "size": "64424509440"}]}'
        )
