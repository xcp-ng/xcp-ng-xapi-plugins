...
BRIDGE_PARAMS = [
    {"input": {"bridge": "xenbr0"}, "result": "xenbr0", "exception": None},
    {"input": {"bridge": "xapi0"}, "result": "xapi0", "exception": None},
    {
        "input": {"bridge": ""},
        "result": None,
        "exception": {
...
IPRANGE_PARAMS = [
    {"input": {"ipRange": "1.1.1.1"}, "result": "1.1.1.1", "exception": None},
    {"input": {"ipRange": "1.1.1.0/24"}, "result": "1.1.1.0/24", "exception": None},
    {
    ...
    },
    {
        ...
        "exception": {
            "type": XenAPIPlugin.Failure,
            "code": "1",
            "text": "ipRange parameter is missing",
        },
    },
]
...
DIRECTION_PARAMS = [
    {"input": {"direction": "to"}, "result": (True, False), "exception": None},
    {"input": {"direction": "TO"}, "result": (True, False), "exception": None},
    {"input": {"direction": "from"}, "result": (False, True), "exception": None},
    {"input": {"direction": "FROM"}, "result": (False, True), "exception": None},
    {"input": {"direction": "to/from"}, "result": (True, True), "exception": None},
    {"input": {"direction": "TO/from"}, "result": (True, True), "exception": None},
    {"input": {"direction": "to/FROM"}, "result": (True, True), "exception": None},
    {"input": {"direction": "from/to"}, "result": (True, True), "exception": None},
    {
        "input": {"direction": ""},
        "result": (None, None),
        "exception": {
...
PROTOCOL_PARAMS = [
    {"input": {"protocol": "ip"}, "result": "ip", "exception": None},
    {"input": {"protocol": "IP"}, "result": "ip", "exception": None},
    {"input": {"protocol": "tcp"}, "result": "tcp", "exception": None},
    {"input": {"protocol": "TCP"}, "result": "tcp", "exception": None},
    {"input": {"protocol": "udp"}, "result": "udp", "exception": None},
    {"input": {"protocol": "UDP"}, "result": "udp", "exception": None},
    {"input": {"protocol": "arp"}, "result": "arp", "exception": None},
    {"input": {"protocol": "ARP"}, "result": "arp", "exception": None},
    {"input": {"protocol": "icmp"}, "result": "icmp", "exception": None},
    {"input": {"protocol": "ICMP"}, "result": "icmp", "exception": None},
    {
        "input": {"protocol": ""},
        "result": None,
...
PORT_PARAMS = [
    {"input": {"port": "4242"}, "result": "4242", "exception": None},
    {"input": {"port": "0"}, "result": "0", "exception": None},
    {"input": {"port": "65535"}, "result": "65535", "exception": None},
    {
        "input": {"port": "65536"},
        "result": None,
        "exception": {
...
ALLOW_PARAMS = [
    {"input": {"allow": "true"}, "result": True, "exception": None},
    {"input": {"allow": "True"}, "result": True, "exception": None},
    {"input": {"allow": "TRUE"}, "result": True, "exception": None},
    {"input": {"allow": "false"}, "result": False, "exception": None},
    {"input": {"allow": "False"}, "result": False, "exception": None},
    {"input": {"allow": "FALSE"}, "result": False, "exception": None},
    {
        "input": {"allow": "bar"},
...
PRIORITY_PARAMS = [
    {"input": {"priority": "100"}, "result": "100", "exception": None},
    {"input": {"priority": "0"}, "result": "0", "exception": None},
    {"input": {"priority": "65535"}, "result": "65535", "exception": None},
    {
