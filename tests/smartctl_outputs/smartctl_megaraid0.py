...
#   INFO -> smartctl -j -a -d megaraid,0 /dev/bus/0 | jq .
#   HEALTH -> smartctl -j -H -d megaraid,0 /dev/bus/0 | jq .
...
INFO_MEGARAID0 = """{
  ...
  "serial_number": "50026B73815A6C11",
  "wwn": {
    "naa": 5,
    "oui": 9911,
    "id": 15055088657
  ...
  "local_time": {
    "time_t": 1738053887,
    "asctime": "Tue Jan 28 09:44:47 2025 CET"
  },
  "smart_status": {
    "passed": true
  },
